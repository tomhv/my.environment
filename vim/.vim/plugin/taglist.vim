...
if !exists('loaded_taglist')
    ...
    command! -nargs=0 -bar TlistHighlightTag call s:Tlist_Window_Highlight_Tag(fnamemodify(bufname('%'), ':p'), line('.'), 2, 1)
...
" php language
let s:tlist_def_php_settings = 'php;d:constant;f:function'
